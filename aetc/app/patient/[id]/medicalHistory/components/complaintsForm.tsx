...
const presentingComplaints = [
  ...
  {
    id: concepts.ABNORMAL_BIZARRE_BEHAVIOUR,
    label: "Abnormal bizzarre behaviour",
  },
  {
    id: concepts.ABNORMAL_LABORATORY_VALUES,
    label: "Abnormal laboratory values",
  },
  ...
  {
    id: concepts.BLOOD_AND_BODY_FLUID_EXPOSURE,
  ...
  {
    id: concepts.CARBON_MONOXIDE_POISONING,
  ...
  {
    id: concepts.EXPOSURE_TO_COMMUNICABLE_DISEASES,
  ...
  {
    id: concepts.FAINTING_SYNCOPE_COLLAPSE,
    label: "Fainting/syncope/collapse",
  },
  ...
  {
    id: concepts.FOREIGN_BODY_OESOPHAGEAL_OR_ORAL,
  ...
  {
    id: concepts.INJURY_ABDOMEN_PENETRATING,
    label: "Injury abdomen penetrating",
  },
  ...
  {
    id: concepts.INJURY_MAJOR_TRAUMA_BLUNT,
    label: "Injury major trauma blunt",
  },
  {
    id: concepts.INJURY_MAJOR_TRAUMA_PENETRATING,
  ...
  {
    id: concepts.OEDEMA_BILATERAL_LEG,
    label: "Oedema bilateral leg (Leg swelling)",
  },
  {
    id: concepts.OEDEMA_GENERALISED,
  ...
  {
    id: concepts.PER_VAGINAL_BLEEDING_WITH_AMENORRHOEA,
  ...
  {
    id: concepts.POSTOPERATIVE_COMPLICATION,
  ...
  {
    id: concepts.SUBSTANCE_WITHDRAWAL_ALCOHOL,
    label: "Substance Withdrawal Alcohol",
  },
  {
    id: concepts.SUBSTANCE_WITHDRAWAL_OPIOID,
    label: "Substance Withdrawal Opioid",
  },
  {
    id: concepts.SUBSTANCE_WITHDRAWAL_BENZODIAZEPINE,
    label: "Substance Withdrawal benzodiazepine",
  },
  // { id: concepts.SUBSTANCE_WITHDRAWAL_OTHER_SPECIFY, label: "Other specify" },
  {
    id: concepts.SURGICAL_ADMISSION_FOR_ELECTIVE_SURGERY,
    label: "Surgical admission for elective surgery",
  },
  {
    id: concepts.SUSPECTED_BOWEL_OBSTRUCTION,
    label: "Suspected bowel obstruction",
  },
  ...
  {
    id: concepts.WALKING_DIFFICULTY,
