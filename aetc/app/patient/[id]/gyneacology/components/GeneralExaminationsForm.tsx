    ...
    if (gyneacologyEncounter && gyneacologyEncounter.obs) {
      ...
      gyneacologyEncounter.obs.forEach((obs) => {
        ...
        if (conceptName === "Chief complaint") {
          ...
          newComplaintsInfo.numberOfLivingChildren =
          ...
          newComplaintsInfo.abnormalVaginalDischarge =
            obs.value || obs.value_text || "";
          ...
          newComplaintsInfo.previousContraceptive =
            obs.value || obs.value_text || "";
          ...
          conceptName &&
          medicalHistoryConceptNames.includes(conceptName)
        ) {
          ...
          newComplaintsInfo.chestExamination =
            obs.value || obs.value_text || "";
        } else if (conceptName === "Abdominal examination") {
          newComplaintsInfo.abdomenExamination =
            obs.value || obs.value_text || "";
        } else if (conceptName === "Vaginal examination") {
          newComplaintsInfo.vaginalExamination =
            obs.value || obs.value_text || "";
      ...
      <div ref={contentRef} className="printable-content">
        <div className="print-only">
          ...
          <div className="patient-examination-data">
            ...
            <p>
              <strong>Prev Abortion: </strong>
              {complaintsInfo.prevAbortion}
            </p>
            <p>
              <strong>Prev Ectopic: </strong>
              {complaintsInfo.prevEctopic}
            </p>
            <p>
              <strong>Abnormal Vaginal Discharge: </strong>
            ...
            <p>
              <strong>Previous Contraceptive: </strong>
            ...
            <p>
              ...
              {complaintsInfo.medicalHistory.length > 0
                ? complaintsInfo.medicalHistory.join(",")
                : "None"}
            </p>
        ...
        <WrapperBox sx={{ bgcolor: "white", padding: "2ch", width: "100%" }}>
          <FormFieldContainerLayout title="General Examination">
            ...
            <FormFieldContainerLayout title="Other Examinations">
              ...
              />
              <TextInputField
                name="vaginalInspection"
                label="Vaginal Inspection"
                type="text"
                id={""}
                multiline
                rows={5}
