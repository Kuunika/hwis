            ...
            <FormFieldContainer direction="column">
                <WrapperBox sx={{ bgcolor: "white", padding: "2ch", width: "100%" }}>
                    <FormFieldContainerLayout title="Personal Information">
                        ...
                        <TextInputField name="educationLevel" label="Education Level" type="text" id={""} />
                        <TextInputField name="address" label="Address" type="text" id={""} />
                        <TextInputField name="ta" label="T/A" type="text" id={""} />
                        <TextInputField name="district" label="District" type="text" id={""} />
                        <TextInputField name="religion" label="Religion" type="text" id={""} />
                        <TextInputField name="maritalStatus" label="Marital Status" type="text" id={""} />
                        <TextInputField name="occupation" label="Occupation" type="text" id={""} />
                        <TextInputField name="seroStatus" label="Sero Status" type="text" id={""} />
                        <TextInputField name="vdrl" label="VDRL" type="text" id={""} />
                        <TextInputField name="nok" label="Next of Kin" type="text" id={""} />
                        <TextInputField name="relationship" label="Relationship" type="text" id={""} />
                        <TextInputField name="contact" label="Contact" type="text" id={""} />
                        <TextInputField name="referred" label="Referred" type="text" id={""} />
                        <TextInputField name="referralReason" label="Reason for Referral" type="text" id={""} />
