...
export const ObstetricGynecologyHistoryForm = ({ onSubmit, onSkip }: Prop) => {
  ...
  const handleSubmit = async (values: any) => {
    ...
    const selectedMenstrualCycle =
      menstrualCycleOptions.find(
        ...
        <WrapperBox sx={{ bgcolor: "white", padding: "2ch", width: "100%" }}>
          <FormFieldContainerLayout title="Obstetric Gynaecology History">
            ...
            <FormFieldContainerLayout title="Contraceptive Use">
              <RadioGroupInput
                name="previousContraceptiveUse"
                options={yesNoOptions}
                label="Previous Use"
              />
              <RadioGroupInput
                name="currentlyOnContraceptive"
                options={yesNoOptions}
            ...
            <RadioGroupInput
              ...
              options={yesNoOptions}
              label="Cancer Screening (VIA/Pap smear)"
            />
            <RadioGroupInput
              name="historyOfSTIs"
              options={yesNoOptions}
