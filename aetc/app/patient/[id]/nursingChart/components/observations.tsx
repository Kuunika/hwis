...
const schema = Yup.object().shape({
  [ObservationFormConfig.oxygenSaturation.name]: Yup.string().label(
    ObservationFormConfig.oxygenSaturation.label
  ),
  [ObservationFormConfig.heartRate.name]: Yup.string().label(
    ObservationFormConfig.heartRate.label
  ),
  [ObservationFormConfig.bloodPressureSystolic.name]: Yup.string().label(
    ObservationFormConfig.bloodPressureSystolic.label
  ),
  [ObservationFormConfig.bloodPressureDiastolic.name]: Yup.string().label(
    ObservationFormConfig.bloodPressureDiastolic.label
  ),
  [ObservationFormConfig.respiratoryRate.name]: Yup.string().label(
    ObservationFormConfig.respiratoryRate.label
  ),
  [ObservationFormConfig.temperature.name]: Yup.string().label(
    ObservationFormConfig.temperature.label
  ),
  [ObservationFormConfig.randomBloodGlucose.name]: Yup.string().label(
    ObservationFormConfig.randomBloodGlucose.label
  ),
  [ObservationFormConfig.urineDipstickKetones.name]: Yup.string().label(
    ObservationFormConfig.urineDipstickKetones.label
  ),
  [ObservationFormConfig.avpu.name]: Yup.string().label(
    ObservationFormConfig.avpu.label
  ),
  [ObservationFormConfig.pefr.name]: Yup.string().label(
    ObservationFormConfig.pefr.label
  ),
  [ObservationFormConfig.triageScore.name]: Yup.string().label(
    ObservationFormConfig.triageScore.label
  ),
  [ObservationFormConfig.units.name]: Yup.string().label(
    ObservationFormConfig.units.label
  ),
});
...
export const ObservationsForm = ({ onSubmit, onSkip, submitting }: Prop) => {
  ...
  const { flow, addKeyToFlow } = useContext(
    KeyValueContext
  ) as KeyValueContextType;
  ...
  const traigeScores = ["Emergency", "Priority", "Queue"];
  ...
  const calculateTriageScore = (value: any, type: string) => {
    ...
    switch (type) {
      ...
      case ObservationFormConfig.heartRate.name:
        ...
        if (
          (numericalValue >= 40 && numericalValue <= 59) ||
          (numericalValue >= 101 && numericalValue <= 129)
        ) {
          score = traigeScores[1];
        }
      ...
      case ObservationFormConfig.bloodPressureSystolic.name:
        ...
        if (
          (numericalValue >= 80 && numericalValue <= 89) ||
          (numericalValue >= 150 && numericalValue <= 200)
        ) {
          return (score = traigeScores[1]);
        }
        if (
          numericalValue >= 90 ||
          (numericalValue > 89 && numericalValue <= 149)
        ) {
        ...
        if (units) {
          if (units == "mg/dl") {
            if (numericalValue < 3 * m || numericalValue > 30 * m) {
              ...
              (numericalValue >= 3.1 * m && numericalValue <= 3.8 * m) ||
              (numericalValue > 11.1 * m && numericalValue <= 29.9 * m)
            ) {
              score = traigeScores[1];
            } else if (
              numericalValue >= 3.9 * m &&
              numericalValue <= 11.1 * m
            ) {
              score = traigeScores[2];
            }
          }
          if (units == "mmol/l") {
            ...
            if (
              (numericalValue >= 3.1 && numericalValue <= 3.8) ||
              (numericalValue > 11.1 && numericalValue <= 29.9)
            ) {
              score = traigeScores[1];
            }
    ...
    Object.keys(flow).forEach((key) => {
      ...
      for (const key in newScores) {
        if (newScores.hasOwnProperty(key)) {
          if (newScores[key] == traigeScores[0]) maxScore = traigeScores[0];
  ...
  return (
    ...
    >
      ...
      <FieldsContainer>
        <TextInputField
          ...
          handleBlurEvent={(value) =>
            addKeyToFlow({
              [ObservationFormConfig.oxygenSaturation.name]: value,
            })
          }
        />
        <TextInputField
          ...
          handleBlurEvent={(value) =>
            addKeyToFlow({
              [ObservationFormConfig.respiratoryRate.name]: value,
            })
          }
        />
      </FieldsContainer>
      <TextInputField
        ...
        handleBlurEvent={(value) =>
          addKeyToFlow({ [ObservationFormConfig.heartRate.name]: value })
        }
        unitOfMeasure="bpm"
      />
      ...
      <FieldsContainer sx={{ mt: "2ch" }}>
        <TextInputField
          ...
          handleBlurEvent={(value) =>
            addKeyToFlow({
              [ObservationFormConfig.bloodPressureSystolic.name]: value,
            })
          }
          unitOfMeasure="mmHg"
        />
        <TextInputField
          ...
          handleBlurEvent={(value) =>
            addKeyToFlow({
              [ObservationFormConfig.bloodPressureDiastolic.name]: value,
            })
          }
          unitOfMeasure="mmHg"
        />
      ...
      <TextInputField
        ...
        handleBlurEvent={(value) =>
          addKeyToFlow({ [ObservationFormConfig.temperature.name]: value })
        }
        unitOfMeasure="°C"
      />
      ...
      <FieldsContainer>
        <UnitInputField
          ...
          handleBlurEvent={(value) =>
            addKeyToFlow({
              [ObservationFormConfig.randomBloodGlucose.name]: value,
            })
          }
        />
      </FieldsContainer>
      <TextInputField
        ...
        handleBlurEvent={(value) =>
          addKeyToFlow({
            [ObservationFormConfig.urineDipstickKetones.name]: value,
          })
        }
      />
      <SearchComboBox
        ...
        disabled={false}
        getValue={(value) =>
          addKeyToFlow({ [ObservationFormConfig.avpu.name]: value })
        }
      />
      <TextInputField
        ...
        handleBlurEvent={(value) =>
          addKeyToFlow({ [ObservationFormConfig.pefr.name]: value })
        }
        unitOfMeasure="L/min"
      />
