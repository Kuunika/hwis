...
const gcsOptions = {
  motorResponse: [
    ...
    {
      value: concepts.ABNORMAL_EXTENSION,
      label: "Abnormal extension (decerebrate posture)",
    },
    {
      value: concepts.ABNORMAL_FLEXION,
      label: "Abnormal flexion (decorticate posture)",
    },
    {
  ...
  verbalResponse: [
    ...
    {
      value: concepts.INCOMPREHENSIBLE_SOUNDS,
      label: "Incomprehensible sounds",
    },
    { value: concepts.INAPPROPRIATE_WORDS, label: "Inappropriate words" },
    {
      value: concepts.CONFUSED_AND_DISORIENTED,
      label: "Confused and disoriented, but able to answer questions",
    },
    {
      value: concepts.ORIENTED_TO_TIME,
      label: "Oriented to time, person, and place, converses normally",
    },
  ],
  eyeResponse: [
    { value: concepts.DOES_NOT_OPEN_EYES, label: "Does not open eyes" },
    {
      value: concepts.OPENS_EYES_IN_RESPONSE_TO_PAIN,
      label: "Opens eyes in response to pain",
    },
    {
      value: concepts.OPENS_EYES_IN_RESPONSE_TO_VOICE,
      label: "Opens eyes in response to voice",
    },
    {
      value: concepts.OPENS_EYES_SPONTANEOUSLY,
      label: "Opens eyes spontaneously",
    },
  ],
};
        ...
        <WrapperBox sx={{ bgcolor: "white", padding: "2ch", width: "100%" }}>
          <FormFieldContainerLayout title="Physical Examination">
            ...
            <FormFieldContainerLayout title="General Condition">
              <RadioGroupInput
                name="general"
                options={physicalExaminationOptions.general}
                label={""}
              />
            </FormFieldContainerLayout>
            ...
            <FormFieldContainerLayout title="Eyes">
              <RadioGroupInput
                name="eyes"
                options={physicalExaminationOptions.eyes}
                label={""}
              />
            </FormFieldContainerLayout>
            ...
            <FormFieldContainerLayout title="Mouth">
              <RadioGroupInput
                name="mouth"
                options={physicalExaminationOptions.mouth}
                label={""}
              />
            </FormFieldContainerLayout>
            ...
            <FormFieldContainerLayout title="Neck">
              <RadioGroupInput
                name="neck"
                options={physicalExaminationOptions.neck}
                label={""}
              />{" "}
            </FormFieldContainerLayout>
            ...
            <FormFieldContainerLayout title="Endocrine Examination">
              <RadioGroupInput
                name="endocrine"
                options={physicalExaminationOptions.endocrine}
                label={""}
              />
            </FormFieldContainerLayout>
            ...
            <FormFieldContainerLayout title="Glasgow Coma Scale (GCS)">
              ...
              <RadioGroupInput
                name="motorResponse"
                options={gcsOptions.motorResponse}
                label={""}
              />
              ...
              <RadioGroupInput
                name="verbalResponse"
                options={gcsOptions.verbalResponse}
                label={""}
              />
              ...
              <RadioGroupInput
                name="eyeResponse"
                options={gcsOptions.eyeResponse}
                label={""}
              />
            </FormFieldContainerLayout>
            ...
            <FormFieldContainerLayout title="Extremities">
              ...
              {gender == "Female" && (
                <TextInputField
                  ...
                  label="Vaginal Examination (For Females Only)"
                  type="text"
                  id={""}
                />
              )}
