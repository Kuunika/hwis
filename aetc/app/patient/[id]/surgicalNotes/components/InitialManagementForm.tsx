  ...
  useEffect(() => {
      ...
      ?.filter(
        (encounter) =>
          ...
          encounter.encounter_type.uuid ===
            encounters.SURGICAL_NOTES_TEMPLATE_FORM
      )
      .sort(
        (a, b) =>
    ...
    if (surgicalEncounter && surgicalEncounter.obs) {
      ...
      surgicalEncounter.obs.forEach((obs) => {
        ...
        const conceptName =
          obs.names && obs.names.length > 0 ? obs.names[0].name : null;
        ...
        if (conceptName === "Clerk name") {
          ...
          newPresentingInfo.surgicalProcedure =
          ...
          newPresentingInfo.differentialDiagnosis =
            obs.value || obs.value_text || "";
          ...
          if (obs.children && obs.children.length > 0) {
            const durationChild = obs.children.find(
              (child) =>
                child.names &&
            ...
            if (durationChild) {
              newPresentingInfo.smoking.duration =
                durationChild.value || durationChild.value_text || "";
            }
          }
          ...
          newPresentingInfo.recreationalDrugs =
            obs.value || obs.value_text || "";
        ...
        if (conceptName === "General condition") {
          ...
          newPhysicalExam.temperature = obs.value_numeric
            ? `${obs.value_numeric}°C`
            : obs.value || "";
          ...
          if (
            ...
            obs.children.forEach((child) => {
              ...
              if (childName === "On treatment") {
                conditionEntry.onTreatment =
                  child.value || child.value_text || "";
              } else if (childName === "Medication") {
                conditionEntry.medication =
                  child.value || child.value_text || "";
              } else if (childName === "Medication Dose") {
                conditionEntry.medicationDose =
                  child.value || child.value_text || "";
              } else if (childName === "Reason for request") {
                conditionEntry.reasonForRequest =
                  child.value || child.value_text || "";
              } else if (childName === "Medication Duration") {
                conditionEntry.medicationDuration =
                  child.value || child.value_text || "";
              }
            });
    ...
    >
      <div ref={contentRef} className="printable-content">
        <div className="print-only">
          ...
          <p>
            <strong>Presenting Complaints:</strong> {presentingInfo.complaints}
          </p>
          <p>
            <strong>Presenting History:</strong> {presentingInfo.history}
          </p>
              ...
              <tbody>
                {pastMedicalHistory.map((history, index) => (
                  <tr key={index}>
                    ...
                    <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                      {history.reasonForRequest}
                    </td>
                    <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                      {history.medicationDuration}
                    </td>
                  </tr>
                ))}
              </tbody>
          ...
          <p>
            <strong>Surgical History:</strong> {presentingInfo.surgicalHistory}
          </p>
          <p>
          ...
          <p>
            ...
            {presentingInfo.familyHistory.length > 0
              ? presentingInfo.familyHistory.join(", ")
              : "None"}
          </p>
          <p>
            <strong>Allergies:</strong> {presentingInfo.allergies || "None"}
          </p>
          ...
          <p>
            ...
            {presentingInfo.smoking.status || "Unknown"}
          </p>
          {presentingInfo.smoking.status === "Yes" && (
            <p>
              <strong>Cigarettes per day:</strong>{" "}
              {presentingInfo.smoking.duration || "Unknown"}
            </p>
          )}
          <p>
            <strong>Alcohol Intake:</strong>{" "}
            {presentingInfo.alcoholIntake
              ? `${presentingInfo.alcoholIntake} units per day`
              : "None"}
          </p>
          <p>
            <strong>Recreational Drugs:</strong>{" "}
            {presentingInfo.recreationalDrugs || "None"}
          </p>
          ...
          <p>
            ...
            {reviewOfSystems.genitourinary.length > 0
              ? reviewOfSystems.genitourinary.join(", ")
              : "None"}
          </p>
          <p>
          ...
          <p>
            ...
            {reviewOfSystems.neurologic.length > 0
              ? reviewOfSystems.neurologic.join(", ")
              : "None"}
          </p>
          <p>
            <strong>Psychiatric:</strong>{" "}
            {reviewOfSystems.psychiatric.length > 0
              ? reviewOfSystems.psychiatric.join(", ")
              : "None"}
          </p>
          <hr />
          ...
          <p>
            ...
            {physicalExam.generalCondition || "Not recorded"}
          </p>
          ...
          <div style={{ display: "flex", gap: "20px", marginBottom: "10px" }}>
            ...
            <p>
              ...
              {physicalExam.pulseRate || "Not recorded"} bpm
            </p>
            <p>
              <strong>Blood Pressure:</strong>{" "}
              {physicalExam.bloodPressure || "Not recorded"} mmHg
            </p>
            <p>
              <strong>Respiratory Rate:</strong>{" "}
              {physicalExam.respiratoryRate || "Not recorded"} breaths/min
            </p>
          </div>

          <p>
            <strong>Eyes:</strong> {physicalExam.eyes || "Not recorded"}
          </p>
          <p>
            <strong>Mouth:</strong> {physicalExam.mouth || "Not recorded"}
          </p>
          <p>
            <strong>Neck:</strong> {physicalExam.neck || "Not recorded"}
          </p>
          <p>
            <strong>Chest Examination:</strong>{" "}
            {physicalExam.chest || "Not recorded"}
          </p>
          <p>
            <strong>Endocrine Examination:</strong>{" "}
            {physicalExam.endocrine || "Not recorded"}
          </p>
          <p>
            <strong>Abdominal Examination:</strong>{" "}
            {physicalExam.abdominal || "Not recorded"}
          </p>

          <h3>Glasgow Coma Scale (GCS)</h3>
          <p>
            <strong>Motor Response:</strong>{" "}
            {physicalExam.motorResponse || "Not recorded"}
          </p>
          <p>
            <strong>Verbal Response:</strong>{" "}
            {physicalExam.verbalResponse || "Not recorded"}
          </p>
          <p>
            <strong>Eye Response:</strong>{" "}
            {physicalExam.eyeResponse || "Not recorded"}
          </p>

          <h3>Additional Examinations</h3>
          <p>
            <strong>Cranial Nerves:</strong>{" "}
            {physicalExam.cranialNerves || "Not recorded"}
          </p>
          <p>
            <strong>Gross Motor:</strong>{" "}
            {physicalExam.grossMotor || "Not recorded"}
          </p>
          <p>
            <strong>Sensation:</strong>{" "}
            {physicalExam.sensation || "Not recorded"}
          </p>

          <h3>Extremities</h3>
          <p>
            <strong>Pulsations:</strong>{" "}
            {physicalExam.pulsations || "Not recorded"}
          </p>
          <p>
            <strong>Rectal Examination:</strong>{" "}
            {physicalExam.rectalExamination || "Not recorded"}
          </p>

          <hr />

          <p>
            <strong>Working Differential Diagnosis:</strong>{" "}
            {presentingInfo.differentialDiagnosis || "None"}
          </p>
          ...
          <p>
            <strong>Additional Notes:</strong> {clerkInfo.additionalNotes}
          </p>
          <p>
            <strong>Clerk Name:</strong> {clerkInfo.clerkName}
          </p>
          <p>
            <strong>Designation:</strong> {clerkInfo.designation}
          </p>
          <p>
            <strong>Signature:</strong> {clerkInfo.signature}
          </p>
        </div>
      </div>
        ...
        <WrapperBox sx={{ bgcolor: "white", padding: "2ch", width: "100%" }}>
          ...
          <FormFieldContainerLayout title="Clerk Information">
            <TextInputField
              ...
              id={""}
            />
            <TextInputField name="designation" label="Designation" id={""} />
            <TextInputField
              name="signature"
              label="Signature"
