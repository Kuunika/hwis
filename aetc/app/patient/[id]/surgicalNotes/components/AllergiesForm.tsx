...
const AllergyItem = ({
  ...
  allergy: { value: string; label: string };
}) => {
  ...
  let detailFieldName = "";
  if (allergy.value === concepts.RECREATIONAL_DRUG)
    detailFieldName = "drugsDetails";
  else if (allergy.value === concepts.FOOD_ALLERGY)
    detailFieldName = "foodDetails";
  else if (allergy.value === concepts.SKIN_PREP)
    detailFieldName = "skinPrepDetails";
  else if (allergy.value === concepts.LATEX_ALLERGY)
    detailFieldName = "latexDetails";
  else if (allergy.value === concepts.MEDICATION_ALLERGY)
    detailFieldName = "medicationsDetails";
