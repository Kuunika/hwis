...
const presentingComplaintsConfig = [
    ...
    { id: concepts.DIFFICULTY_PAIN_ON_PASSING_STOOLS, label: "Difficulty/Pain on passing stools" },
    ...
    { id: concepts.PASSING_DEEP_YELLOW_URINE, label: "Passing deep yellow urine" },
