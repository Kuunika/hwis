...
const proceduresConfig = [
  ...
  {
    value: concepts.INTERCOSTAL_DRAIN_INSERTION,
  ...
  {
    value: concepts.CATHETERIZATION_SUPRAPUBIC,
  ...
  {
    value: concepts.ENDOTRACHEAL_TUBE_INSERTION,
  ...
  {
    value: concepts.CONTINUOUS_POSITIVE_AIRWAY_PRESSURE,
