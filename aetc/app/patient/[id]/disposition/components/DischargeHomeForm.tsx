...
import {
    ...
    TextInputField,
    SearchComboBox,
    RadioGroupInput, PatientInfoTab,
} from "@/components";
                            ...
                            <>
                                <div ref={printRef} className="printable-content">
                                    <div className="print-only">
                                        <PatientInfoTab />
                                        <p><strong>Discharge Plan:</strong> {values.dischargePlan}</p>
                                        <p><strong>Followup Plan:</strong> {values.followUpPlan}</p>
                                        <p><strong>Home care Instructions:</strong> {values.homeCareInstructions}</p>
                                        <p><strong>Follow up details:</strong> {values.followUpDetails}</p>
                                        <p><strong>Discharge notes:</strong> {values.dischargeNotes}</p>
                                        <p><strong>Specialist Clinic (if applicable):</strong> {values.specialistClinic}</p>
                                    </div>
                                </div>
