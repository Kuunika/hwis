...
const validationSchema = Yup.object({
  ...
  vitalSignsMonitoring: Yup.string().required(
    "Vital Signs Monitoring option is required"
  ),
    ...
    const obs = [
      {
        ...
        groupMembers: [
          ...
          {
            concept: concepts.VITAL_SIGNS,
            value: values.vitalSignsMonitoring,
            obsDatetime: currentDateTime,
          },
          {
            concept: concepts.SOAP_NOTES,
