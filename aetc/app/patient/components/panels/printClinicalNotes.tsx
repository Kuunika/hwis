...
import { PrimarySurvey } from "./PrimarySurvey"; // Import the new component
...
export const PrintClinicalNotes = (props: any) => {
  ...
  const hasPrimaryContent = panelData.primary && Array.isArray(panelData.primary) && panelData.primary.length > 0;
            ...
            <Grid container>
              ...
              {(hasTriageContent || hasVitalContent || hasPrimaryContent) && (
                ...
                >
                  ...
                  {/* Primary Survey - Using the new component */}
                  {hasPrimaryContent && (
                    <PrimarySurvey 
                      panelData={panelData.primary} 
