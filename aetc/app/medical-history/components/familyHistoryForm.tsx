...
export const FamilyHistoryForm = ({ onSubmit, onSkip }: Prop) => {
  ...
  const schema = yup.object().shape({
    ...
    hypertensionRelationship: yup.string().when("hypertension", {
      ...
      then: yup
        .string()
        .required("Please specify relationship for hypertension"),
    }),
    ...
    diabetesMellitusRelationship: yup.string().when("diabetes_mellitus", {
      ...
      then: yup
        .string()
        .required("Please specify relationship for diabetes mellitus"),
    }),
    ...
    tuberculosisRelationship: yup.string().when("tuberculosis", {
      ...
      then: yup
        .string()
        .required("Please specify relationship for tuberculosis"),
    }),
    other: yup.boolean(),
    ...
    otherRelationship: yup.string().when("other", {
      ...
      then: yup
        .string()
        .required("Please specify relationship for the other condition"),
    }),
  });
