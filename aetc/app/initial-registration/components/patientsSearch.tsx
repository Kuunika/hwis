...
export const PatientSearchResultsDialog = ({
  open,
  onClose,
  isLoading,
  patientResults,
  ...
  useEffect(() => {
    const error = visitError || visitNumberError || encounterError;
  ...
  const columns = [
    ...
    {
      field: "currentTraditionalAuthority",
      headerName: "Current TA",
      flex: 1,
      renderCell: (cell: any) => {
