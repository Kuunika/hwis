...
export const DemographicsSearch = ({ patient, genericSearch = false }: { patient: Person, genericSearch?: boolean }) => {
...
export const NPIDSearch = ({ genericSearch = true }: { genericSearch?: boolean }) => {
