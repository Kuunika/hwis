...
import { DemographicsSearch, NPIDSearch } from "./searchComponents";
...
export default AuthGuard(RegistrationSearchPage, [roles.ADMIN, roles.CLINICIAN, roles.REGISTRATION_CLERK, roles.NURSE])