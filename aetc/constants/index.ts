export const encounters = {
  ...
  INITIAL_REGISTRATION: "07707171-ea7e-4832-82b3-bf503560cc61",
...
export const concepts = {
  ...
  SCAPHOID: "Scaphoid",
  OUTCOME: "Outcome",
  HOSPITALIZATION_STATUS: "Hospitalization Status",
  IS_PATIENT_IN_ICU_HDU: "Is patient in ICU/HDU",
  ANTIMICROBIALS_GIVEN_PRIOR_TO_ADMISSION: "Antimicrobials given prior to admission",
  CURRENT_ANTIMICROBIAL_THERAPY: "Current Antimicrobial Therapy",
  HTC_HIV_OUTCOME: "HTC HIV Outcome",
  LIST_OF_COMORBIDITIES: "List of Comorbidities",
  LENGTH_OF_STAY: "Length of Stay",
  DATE_OF_ADMISSION:"Date of Admission",
  DATE_OF_SAMPLE_COLLECTION:"Date of Sample Collection",
  TIME_OF_SAMPLE_COLLECTION:"Time of Sample Collection",
  COMORBIDITIES:"Comorbidities",
  PHONE_NUMBER:"Phone Number",
  SPECIMEN_COLLECTION_CONDITION:"Specimen Collection Condition",
 WERE_ANTIMICROBIALS_GIVEN: "Were Antimicrobials Given",
 IS_THERE_CURRENT_ANTIMICROBIAL_THERAPY: "Is There Current Antimicrobial Therapy",
