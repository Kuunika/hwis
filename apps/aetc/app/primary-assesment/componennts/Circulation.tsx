...
const schema = yup.object({
  ...
  [form.abdnomenInfo.name]: yup
    .string()
    .required()
    .label(form.abdnomenInfo.label),
  ...
  [form.meanArterialPressureInfo.name]: yup
    .string()
    .required()
    .label(form.meanArterialPressureInfo.label),
